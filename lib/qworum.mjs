 ...
 * 
 * - <code>[eval()](#method_eval_0)</code> evaluates a Qworum script.
 * - <code>[setData()](#method_setData_0)</code> sets the value of a data container.
 * - <code>[getData()](#method_getData_0)</code> reads the value of a data container.
 * 
 * Other methods:
 * 
 * - <code>[checkAvailability()](#method_checkAvailability_0)</code> verifies that Qworum is available on the user's web browser.
 * 
