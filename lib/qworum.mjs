...
class Qworum {
  ...
  /**
   * 
   * @param {boolean} userObjectName if the persona isn't set yet for the session, then call qworum://user/set-persona for this Qworum object.
        ...
        if (userObjectName) {
          ...
          this.eval(
            Script.build(
              Sequence.build(
                Try.build(
                  Call.build('user', 'qworum://user/set-persona'), // which Qworum object name ?
                  {
