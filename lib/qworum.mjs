...
class Qworum {
  ...
  // /**
  //  * Returns the {@link Persona} that is tied to the current Qworum session. If a persona isn't set yet for the session, then the web browser launches a user dialog for helping the end-user choose one.
  //  * 
