...
class SemanticData extends GenericData {
   ...
   * @returns {boolean}
   */
  async readFromText(text, baseIRI){ // BUG base IRI
    if (typeof text !== 'string') throw new TypeError(`not a text`);
    if(baseIRI && !(baseIRI instanceof URL)) throw new TypeError(`not an IRI`);
