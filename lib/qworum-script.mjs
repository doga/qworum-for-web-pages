 ...
 */
import { N3, IRI, DataflowMessage } from '../deps.mjs';
 ...
 * ```
 * @see {@link https://qworum.net/en/specification-v1.0/#json | The Json data value}
 */
class Json extends GenericData {
   ...
   * ```
   * @see {@link https://qworum.net/en/specification-v1.0/#json|Json definition in the Qworum specification}
   */
  static build(value) {
...
/**
 * In-memory RDF dataset. Conformant with [RDF 1.1](https://www.w3.org/TR/turtle/), [RDF-Star](https://www.ontotext.com/knowledgehub/fundamentals/what-is-rdf-star/) and the [RDF/JS Dataset interface](https://rdf.js.org/dataset-spec/#dataset-interface). Can be stored in `Data` containers.
 * @example
 * ```javascript
 ...
 * @see {@link https://www.w3.org/TR/turtle/ | RDF 1.1 Turtle, Terse RDF Triple Language}
 * @see {@link https://www.ontotext.com/knowledgehub/fundamentals/what-is-rdf-star/ | What Is RDF-star?}
 * @see {@link https://qworum.net/en/specification-v1.0/#semantic | The SemanticData data value}
 */
class SemanticData extends GenericData {
   ...
   * @see {@link https://qworum.net/en/specification-v1.0/#semantic|SemanticData definition in the Qworum specification}
   */
  static build() {
   ...
   * 
   * @type {object} an N3.Store object
   * @see {@link https://rdf.js.org/dataset-spec/#dataset-interface | Dataset specification}
   **/
  get value() {
      return this._value;
  }
  /** @ignore */
  _toString() {
    return JSON.stringify(DataflowMessage.fromRDF(this.value).toObject());
  }
  ...
  static fromJsonable(encodedData) {
    ...
    //   res._value = DataflowMessage.fromObject(encodedData.value).toRDF();
      res.value.addAll(DataflowMessage.fromObject(encodedData.value).toRDF());
  ...
  toJsonable() {
    return {
      type: `${SemanticData.namespace} ${SemanticData.tag}`,
      value: DataflowMessage.fromRDF(this.value).toObject()
    };
  }
}
 ...
 * ```
 * @see {@link https://qworum.net/en/specification-v1.0/#fault | The Fault instruction}
 */
class Fault extends Instruction {
  ...
  constructor(type, types){
      ...
      if(typeof type !== 'string')throw new FaultTypeError();
      type = type.trim().toLowerCase().replaceAll(/\s+/g, ' ');
 ...
 * @example
 * ```javascript
 * const ret = Return.build(Json.build(123));
 * ret.statement.value === 123; // true
 * ```
 * @see {@link https://qworum.net/en/specification-v1.0/#return | The Return instruction}
 */
 ...
 * @example
 * ```javascript
 * const sequence = Sequence.build(Call.build('@', '/aClass/aMethod'), Goto.build());
 * ```
 * @see {@link https://qworum.net/en/specification-v1.0/#sequence | The Sequence instruction}
 */
 ...
 * @example Writing to a data container in a Qworum script
 * ```javascript
 * const data1 = Data.build('data1', Json.build(2026));
 * ```
 * @example Reading from a data container in a Qworum script
 * ```javascript
 * const data2 = Data.build('data1');
 * ```
 * @see {@link https://qworum.net/en/specification-v1.0/#data|Data definition in the Qworum specification}
 * @see {@link https://qworum.net/en/specification-v1.0/#data | The Data instruction}
 */
 ...
 * );
 * ```
 * @see {@link https://qworum.net/en/specification-v1.0/#try | The Try instruction}
 */
class Try extends Instruction {
  ...
  constructor(statement, catchClauses){
      ...
      for (const catchClauseArg of catchClauses){
          ...
          for (const faultType of catchClause['catch'])
            try {
                new Fault(faultType);
            } catch (_error) {
          ...
          if (!catchClause['do']) throw new Error('catch clause must have a `do` statement');
          c.push(catchClause);
      }
 ...
 * ```
 * @see {@link https://qworum.net/en/specification-v1.0/#goto | The Goto instruction}
 */
 ...
 * ```
 * @example A call with data arguments:
 * ```javascript
 ...
 * );
 * ```
 * @example A call with data and Qworum-object arguments:
 * ```javascript
 ...
 * );
 * ```
 * @see {@link https://qworum.net/en/specification-v1.0/#call | The Call instruction}
 */
 ...
 *   Sequence.build(
 *     Call.build('@', '/aClass/aMethod'), 
 *     Goto.build()
 *   )
 * );
 * ```
 * @see {@link https://qworum.net/en/specification-v1.0/#script | The Qworum script}
 */
class Script {
  /** @ignore */
   ...
   * );
   * ```
   * @see {@link https://qworum.net/en/specification-v1.0/#script|Script definition in the Qworum specification}
   */
