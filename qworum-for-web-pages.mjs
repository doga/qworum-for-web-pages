...
class SemanticData extends GenericData {
    ...
    static fromXmlElement(element, namespaceStack) {
        ...
        try {
            ...
            result = new SemanticData(text, type);
        } catch (error) {
            errorMessage = `${error}`;
        } finally{
            nsStack.pop();
    ...
    static fromIndexedDb(encodedData) {
        ...
        return new SemanticData(encodedData.value.text, encodedData.value.type);
    }
    toIndexedDb() {
        return {
...
// export const MESSAGE_VERSION = '0.9.9';


const MESSAGE_VERSION = '0.9.9';
