...
`import { QworumScript, Qworum } from "https://esm.sh/gh/doga/qworum-for-web-pages@1.8.1/mod.mjs";`
...
```javascript
import { SemanticData, Qworum } from 'https://esm.sh/gh/doga/qworum-for-web-pages@1.8.1/mod.mjs';
